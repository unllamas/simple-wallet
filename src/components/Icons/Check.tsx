...
export function Check({ width, css }: PropsIconCheck): JSX.Element {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width={width} height='100%' viewBox='0 0 24 24' style={css} fill='currentColor'>
